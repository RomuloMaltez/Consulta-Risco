export const DADOS_ALTO_RISCO = `1012-1/01|Abate de aves
...
2422-9/00|Produção de laminados planos de aço ao carbono, revestidos ou não
2422-9/01|Produção de laminados planos de aços especiais
...
export const DADOS_MEDIO_RISCO = `5231-1/01|Administração da infra-estrutura portuária
...
3317-1/02|Manutenção e reparação de embarcações para esportes e lazer
...
6438-7/02|Outra instituições de intermediação não-monetária não especificadas anteriormente
...
export const DADOS_BAIXO_RISCO = `1531-9/02|Acabamento de calçados de couro sob contrato
...
4647-8/02|Comércio atacadista de artigos de escritório e de papelaria
...
4647-8/01|Comércio atacadista de bolsas, malas e artigos de viagem
...
3511-5/01|Geração de energia elétrica (Energia Solar)
